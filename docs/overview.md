...
* **基于 Python + PyQt5**：兼容 Windows 7+ x64平台，源代码以 GPL‑3.0 协议发布，鼓励开源贡献与衍生。([GitHub][1])
* **活跃迭代**：自 v1.0.0.0 到最新 v1.1.2.0-beta（2025 年 8 月 1 日发布）的多个版本，体现项目活力与持续更新。([GitHub][1])



## 七、如何上手？

1. 访问 SECTL/SecRandom 仓库，点击“Release”下载最新测试版（v1.1.2.0-beta）。([GitHub][1])
...
[1]: "https://github.com/SECTL/SecRandom"GitHub - SECTL/SecRandom: 便捷且现代化的界面拥有多种抽取方式"
