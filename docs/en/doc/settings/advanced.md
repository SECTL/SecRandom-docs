...
>
> Here you can fine-tune SecRandom's core fairness algorithms, page elements, etc., to meet more complex selection needs.

## ::lucide:scale:: Basic Fairness Settings

Configure the basic calculation methods for fairness selection, determining which factors participate in the fairness calculation.

- **Fair Selection by Total Count**: When enabled, the system dynamically adjusts weights based on each person's total number of times selected; fewer times means higher weight.
- **Fair Selection by Group**: When enabled, the selection status of groups will participate in the fairness calculation to balance the winning opportunities of each group.
- **Fair Selection by Gender**: When enabled, the selection status of genders will participate in the fairness calculation to balance the winning opportunities of different genders.
- **Fair Selection by Time**: When enabled, time factors will be considered in the fairness calculation.
...
## ::lucide:shield:: Selection Protection Settings

Configure shielding rules after selection to prevent repeated selection of the same person within a short time.

- **Enable Post-Selection Shielding**: When enabled, students just selected will be "shielded" for a specified time and will not be selected again.
- **Shielding Time**: Set the duration of the post-selection shielding.
...
- **Application Location**: Set independent music configurations for "Roll Call", "Quick Draw", and "Lottery".
- **Process Music**: Set the background music played during the selection process.
...
- **Result Music**: Set the sound effect or music played when the selection result is displayed.
...
- **Selection Panel Position**: Choose the display position of the selection panel (Left/Right).
