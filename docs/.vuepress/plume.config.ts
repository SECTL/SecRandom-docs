...
export default defineThemeConfig({
  ...
  social: [
    { icon: 'github', link: 'https://github.com/SECTL/SecRandom' },
    {
      icon: {
      ...
      link: 'https://forum.smart-teach.cn/t/secrandom'
    },
    { icon: 'bilibili', link: 'https://space.bilibili.com/520571577/lists/5553789' },
