...
const downloadSources: DownloadSource[] = [
  { id: 'github', name: 'GitHub 源', icon: '/icon/github.svg', description: '官方发布渠道', speed: '海外较快' },
  { id: 'ghfast', name: 'GitHub 第三方镜像源', icon: '/icon/github.svg', description: 'ghfast.top 加速', speed: '国内较快' },
  { id: 'ghproxy', name: 'GitHub 第三方镜像源', icon: '/icon/github.svg', description: 'gh-proxy.com 加速', speed: '国内较快' },
  { id: 'cloud123', name: '123云盘源', icon: '/icon/123pan.png', description: '云盘下载页面', speed: '不限速', contributor: { name: 'lzy98276', url: 'https://github.com/lzy98276' } }
]
